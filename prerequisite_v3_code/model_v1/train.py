...
if __name__ == "__main__":
  ...
  log_dir = util.mkdirs(os.path.join(config["log_dir"], "PublicKeyCryptography_euclidean"))
  # log_dir = util.mkdirs(os.path.join(config["log_dir"], "v1_PublicKeyCryptography_lambda:" + str(config["lambda"])))
