...
class CorefModel(object):
  ...
  def get_predictions_and_loss(self, pre_topic_word, post_topic_word, pre_topic_start_index, pre_topic_end_index, post_topic_start_index, post_topic_end_index, pre_tokens, post_tokens, pre_context_word_emb, post_context_word_emb, pre_head_word_emb, post_head_word_emb, pre_lm_emb, post_lm_emb, pre_char_index, post_char_index, pre_text_len, post_text_len, is_training, label):
    ...
    with tf.variable_scope("pre_topic"):
      pre_topic_emb, pre_top_span_emb, pre_top_span_mention_scores, pre_top_antecedent_emb, pre_top_antecedent_scores, pre_top_antecedents, pre_top_span_starts, pre_top_span_ends = self.get_predictions(pre_topic_start_index, pre_topic_end_index, pre_tokens, pre_context_word_emb, pre_head_word_emb, pre_lm_emb, pre_char_index, pre_text_len, is_training)
    with tf.variable_scope("post_topic"):
      post_topic_emb, post_top_span_emb, post_top_span_mention_scores, post_top_antecedent_emb, post_top_antecedent_scores, post_top_antecedents, post_top_span_starts, post_top_span_ends = self.get_predictions(post_topic_start_index, post_topic_end_index, post_tokens, post_context_word_emb, post_head_word_emb, post_lm_emb, post_char_index, post_text_len, is_training)
    ...
    post_topic_pre_antecedent_cosin = self.topic_span_similarity(temp_post_topic_emb, pre_top_antecedent_emb, 2)  # [pre_k, pre_c]
    temp_post_topic_emb = tf.tile(tf.expand_dims(post_topic_emb, 0), [post_k, post_c, 1])  # [post_k, post_c]
    post_topic_post_antecedent_cosin = self.topic_span_similarity(temp_post_topic_emb, post_top_antecedent_emb, 2)  # [post_k, post_c]
    ...
    # pre_topic作为后序词    pre_antecedent
    pre_topic_relation_score1, pre_pre_top_antecedent_scores, pre_topic_pre_antecedents = self.get_topic_relation_score(pre_topic_pre_antecedent_cosin, pre_top_antecedent_scores, post_topic_pre_span_cosin, pre_top_span_mention_scores, pre_k, pre_c, pre_top_antecedents)
    pre_topic_relation_score2, pre_post_top_antecedent_scores, pre_topic_post_antecedents = self.get_topic_relation_score(pre_topic_post_antecedent_cosin, post_top_antecedent_scores, post_topic_post_span_cosin, post_top_span_mention_scores, post_k, post_c, post_top_antecedents)
    pre_topic_relation_score = pre_topic_relation_score + pre_topic_relation_score1 + pre_topic_relation_score2

    post_topic_relation_score1, post_pre_top_antecedent_scores, post_topic_pre_antecedents = self.get_topic_relation_score(post_topic_pre_antecedent_cosin, pre_top_antecedent_scores, pre_topic_pre_span_cosin, pre_top_span_mention_scores, pre_k, pre_c, pre_top_antecedents)
    post_topic_relation_score2, post_post_top_antecedent_scores, post_topic_post_antecedents = self.get_topic_relation_score(post_topic_post_antecedent_cosin, post_top_antecedent_scores, pre_topic_post_span_cosin, post_top_span_mention_scores, post_k, post_c, post_top_antecedents)
    post_topic_relation_score = post_topic_relation_score + post_topic_relation_score1 + post_topic_relation_score2

    # pre_topic_relation_score += self.get_topic_relation_score(pre_topic_pre_antecedent_cosin, pre_top_antecedent_scores, post_topic_pre_span_cosin, pre_top_span_mention_scores, pre_k, pre_c, pre_top_antecedents)
    # # pre topic作为后序词    post antecedent
    # pre_topic_relation_score += self.get_topic_relation_score(pre_topic_post_antecedent_cosin, post_top_antecedent_scores, post_topic_post_span_cosin, post_top_span_mention_scores, post_k, post_c, post_top_antecedents)
    # # post topic作为后序词    pre antecedent
    # post_topic_relation_score += self.get_topic_relation_score(post_topic_pre_antecedent_cosin, pre_top_antecedent_scores, pre_topic_pre_span_cosin, pre_top_span_mention_scores, pre_k, pre_c, pre_top_antecedents)
    # # post topic作为后序词     post antecedent
    # post_topic_relation_score += self.get_topic_relation_score(post_topic_post_antecedent_cosin, post_top_antecedent_scores, pre_topic_post_span_cosin, post_top_span_mention_scores, post_k, post_c, post_top_antecedents)
    ...
    return loss,post_topic_relation_score, pre_topic_relation_score, label, final_score, [pre_topic_emb, post_topic_emb, pre_top_span_emb, post_top_span_emb, pre_top_span_mention_scores, post_top_span_mention_scores, pre_top_antecedent_emb, post_top_antecedent_emb, pre_pre_top_antecedent_scores, pre_post_top_antecedent_scores, post_pre_top_antecedent_scores, post_post_top_antecedent_scores, final_score, pre_top_span_starts, pre_top_span_ends, pre_topic_pre_antecedents, pre_topic_post_antecedents, post_top_span_starts, post_top_span_ends, post_topic_pre_antecedents, post_topic_post_antecedents]
  ...
  def get_topic_relation_score(self, antecedent_cosin, antecedent_scores, span_cosin, span_score, dim2, dim3, top_antecedents):
    ...
    :param dim2:
    :param dim3:
    :param top_antecedents: [dim2, dim3]
    :return:
    '''
    ...
    pre_topic_pre_mask = tf.logical_and(
      ...
      tf.greater_equal(post_topic_pre_span_relation, tf.fill([dim2, dim3], metric)))   #[dim2,dim3] eg:[pre_k, pre_c]
    ...
    antecedent_scores = tf.boolean_mask(antecedent_scores, pre_topic_pre_mask)
    top_antecedents = tf.boolean_mask(top_antecedents, pre_topic_pre_mask)
    return tf.reduce_sum(pre_topic_as_antecedent), antecedent_scores, top_antecedents
    # return tf.reduce_mean(pre_topic_as_antecedent)
  ...
  def get_predictions(self, topic_start_index, topic_end_index, tokens, context_word_emb, head_word_emb, lm_emb, char_index, text_len, is_training):    #contex embedding和lm embedding不一样
      ...
      dummy_antecedents = tf.fill([k,1], 0)
      top_antecedents = tf.concat([dummy_antecedents, top_antecedents], 1)
      '''
      ...
      return topic_emb, top_span_emb, top_span_mention_scores, top_antecedent_emb, top_antecedent_scores, top_antecedents, top_span_starts, top_span_ends
  ...
  def get_predicted_antecedents(self, antecedents, antecedent_scores):
    ...
    print("antecedent scores : ", antecedent_scores.shape)
    print("antecedents: ", antecedents.shape)
    for i, index in enumerate(antecedent_scores - 1):# axis=1原本
      if index < 0:
  ...
  def evaluate(self, session, official_stdout=False):
    ...
    for example_num, (tensorized_example, example) in enumerate(self.eval_data):    # example为载入的原始json数据
      ...
      print("pre topic: ", example["pre_topic"], "   post topic: ", example["post_topic"])

      pre_topic_emb, post_topic_emb, pre_top_span_emb, post_top_span_emb, pre_top_span_mention_scores, post_top_span_mention_scores, pre_top_antecedent_emb, post_top_antecedent_emb, pre_pre_top_antecedent_scores, pre_post_top_antecedent_scores, post_pre_top_antecedent_scores, post_post_top_antecedent_scores, final_score, pre_top_span_starts, pre_top_span_ends, pre_topic_pre_antecedents, pre_topic_post_antecedents, post_top_span_starts, post_top_span_ends, post_topic_pre_antecedents, post_topic_post_antecedents = session.run(self.predictions, feed_dict=feed_dict)

      pre_topic_pre_predicted_antecedents = self.get_predicted_antecedents(pre_topic_pre_antecedents, pre_pre_top_antecedent_scores)
      pre_topic_post_predicted_antecedents = self.get_predicted_antecedents(pre_topic_post_antecedents, pre_post_top_antecedent_scores)
      post_topic_pre_predicted_antecedents = self.get_predicted_antecedents(post_topic_pre_antecedents, post_pre_top_antecedent_scores)
      post_topic_post_predicted_antecedents = self.get_predicted_antecedents(post_topic_post_antecedents, post_post_top_antecedent_scores)

      file_key = example["pre_topic"] + "_" + example["post_topic"]
      original_label = int(example["label"])
      if original_label != 1:
        original_label = 0
      pre_topic_pre_predicted_clusters, pre_topic_pre_mention_to_predicted = self.evaluate_coref(pre_top_span_starts, pre_top_span_ends, pre_topic_pre_predicted_antecedents)
      pre_topic_post_predicted_clusters, pre_topic_post_mention_to_predicted = self.evaluate_coref(post_top_span_starts, post_top_span_ends, pre_topic_post_predicted_antecedents)
      post_topic_pre_predicted_clusters, post_topic_pre_mention_to_predicted = self.evaluate_coref(pre_top_span_starts, pre_top_span_ends, post_topic_pre_predicted_antecedents)
      post_topic_post_predicted_clusters, post_topic_post_mention_to_predicted = self.evaluate_coref(post_top_span_starts, post_top_span_ends, post_topic_post_predicted_antecedents)

      coref_predictions[file_key] = [final_score, original_label, example["pre_topic"], example["post_topic"], pre_topic_pre_mention_to_predicted, pre_topic_post_mention_to_predicted,
